...
class ReporteModel(Base):
    ...
    grupo_incidente_id: Mapped[str | None] = mapped_column(String(36), nullable=True, index=True)
    ...
    clasificacion_ia = relationship("ClasificacionIAModel", back_populates="reporte", uselist=False, cascade="all, delete-orphan")
